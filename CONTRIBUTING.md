# Contributing to Stacks · FitBizStack
...
```bash
git clone https://github.com/SkyYield-LLC/FitBizStack.git
cd fitbizstack
npm install
...
- `main` → production (auto-deploys to https://fitbizstack.vercel.app)
...
Push to `main` → Vercel auto-deploys to https://fitbizstack.vercel.app.

## Where to ask for help

- **Linear:** [Stacks · FitBizStack](https://linear.app/skyyield/project/stacks-fitbizstack-e6f9773c50f4) — file an issue or comment on existing
